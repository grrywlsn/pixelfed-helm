...
![Version: v3.1.1](https://img.shields.io/badge/Version-v3.1.1-informational?style=flat-square) ![AppVersion: 0.12.5](https://img.shields.io/badge/AppVersion-0.12.5-informational?style=flat-square)
...
|------------|------|---------|
| https://charts.bitnami.com/bitnami | redis | 21.0.3 |
...
| image.tag | string | `"v3.1.1"` | version of the image to pull |
