...
![Version: v3.0.2](https://img.shields.io/badge/Version-v3.0.2-informational?style=flat-square) ![AppVersion: 0.12.5](https://img.shields.io/badge/AppVersion-0.12.5-informational?style=flat-square)
...
| image.tag | string | `"v3.0.2"` | version of the image to pull |
