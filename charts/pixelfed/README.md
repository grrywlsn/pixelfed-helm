...
![Version: v2.0.4](https://img.shields.io/badge/Version-v2.0.4-informational?style=flat-square) ![AppVersion: 0.12.5](https://img.shields.io/badge/AppVersion-0.12.5-informational?style=flat-square)
...
| image.tag | string | `"v2.0.4"` | version of the image to pull |
