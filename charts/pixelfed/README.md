...
![Version: v3.6.0](https://img.shields.io/badge/Version-v3.6.0-informational?style=flat-square) ![AppVersion: 0.12.5](https://img.shields.io/badge/AppVersion-0.12.5-informational?style=flat-square)
...
| image.tag | string | `"v3.6.0"` | version of the image to pull |
